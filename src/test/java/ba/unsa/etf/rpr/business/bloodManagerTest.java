...
*/
    ...
    void validateBloodType() throws BloodException{
        ...
        assertEquals("Blood type must contain between 2 and 3 characters", bloodException1.getMessage());
        ...
        assertEquals("Blood type must contain between 2 and 3 characters", bloodException2.getMessage());
    }
...
*/
    ...
    void add() throws BloodException {
        ...
        assertEquals("Can't add information with ID. ID is autogenerated", bloodException.getMessage());
